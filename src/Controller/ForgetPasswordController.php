        ...
        public function index(Request $request)
        {
            ...
            if ($request->get('email')) {
                ...
                if ($user) {
                    ...
                    $content = "Bonjour ".$user->getUserIdentifier()."<br/>Vous avez demandé à réinitialiser votre mot de passe sur le site Huvlin<br/><br/>";
                    $content .= "Merci de bien vouloir cliquer sur le lien suivant pour <a href='".$url."'>mettre à jour votre mot de passe</a>.";
    
                    $mail = new Mail();
                    $mail->send($user->getEmail(), $user->getnom().' '.$user->getprenom(), 'Réinitialiser votre mot de passe sur le site Huvlin', $content);
